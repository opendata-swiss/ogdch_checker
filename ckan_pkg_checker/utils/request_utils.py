...
def _check_url_status(test_url, http_method='HEAD'):
    ...
    try:
        user_agent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_1) ' \
                     ...
                     'Chrome/55.0.2883.75 ' \
                     'Safari/537.36'
        req = session.request(http_method, test_url,
                              verify=False,
                              timeout=30,
...
class RetryAdapter(HTTPAdapter):
    def __init__(self, *args, **kwargs):
        ...
        self.max_retries = Retry(total=3, backoff_factor=5,
