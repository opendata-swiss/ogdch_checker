...
def set_up_contact_mapping(config, ogdremote):
    ...
    print(organization_with_parents)
    ...
    for organization_name in organization_with_parents:
        ...
        if organization_admin_userids:
            ...
            log_and_echo_msg(f"-> got contacts {dcat_contact_key} {contact_dict[dcat_contact_key]}")
            continue
        contact_dict[dcat_contact_key] = [dcat_admin_email]
        log_and_echo_msg(f"-> got default contacts {dcat_contact_key} {contact_dict[dcat_contact_key]}")
